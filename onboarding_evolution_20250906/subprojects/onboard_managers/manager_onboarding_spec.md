# Manager/Leader Onboarding Specification

## Partial Name
`_onboard_managers.html.erb`

## Location
`~/Development/resultmaps-web/app/views/today/_onboard_managers.html.erb`
...
- `ObjectMeta` storage (key: `user_onboarding`)
- `User::OnboardingMeta` concern methods
- Persona-based configuration (manager/leader persona)
